...
// https://tc39.github.io/ecma262/#sec-array.prototype.foreach
var arrayForEach = (!STRICT_METHOD$2 || !USES_TO_LENGTH$6) ? function forEach(callbackfn /* , thisArg */) {
...
var slice_1 = function (it) {
  var own = it.slice;
  return it === ArrayPrototype$9 || (it instanceof Array && own === ArrayPrototype$9.slice) ? slice : own;
};
  ...
  for (var k = 0; k < slice$2(updatePath).call(updatePath, 0, -1).length; k++) {
    ...
    while (++index < currentPaths.length) {
      ...
      if (currentPathsLength === index) {
        if (isObject$1(objectRef) && isEmptyObject(objectRef) || isArray$4(objectRef) && !filter$2(objectRef).call(objectRef, function (data) {
...
var getFieldsValues = (function (fields, search) {
  ...
  var _loop_1 = function (name_1) {
    if (isUndefined(search) || (isString(search) ? startsWith$2(name_1).call(name_1, search) : isArray$4(search) ? find$2(search).call(search, function (data) {
...
var compareObject = (function (objectA, objectB) {
  ...
  var objectAData = entries$2(objectA);

  var objectBData = keys$3(objectB);

  return objectAData.length === objectBData.length && reduce$2(objectAData).call(objectAData, function (previous, _a) {
    var _b = __read(_a, 2),
        key = _b[0],
        value = _b[1];
          ...
          if (required && (!isRadio && !isCheckBox && (isEmpty || isNullOrUndefined(value)) || isBoolean(value) && !value || isCheckBox && !getCheckboxValue(options).isValid || isRadio && !getRadioValue(options).isValid)) {
            ...
            if (requiredValue) {
              error[name] = __assign({
                ...
                ref: isRadioOrCheckbox ? (_o = fields[name].options) === null || _o === void 0 ? void 0 : _o[0].ref : ref
...
var flat_1 = function (it) {
  var own = it.flat;
  return it === ArrayPrototype$a || (it instanceof Array && own === ArrayPrototype$a.flat) ? flat : own;
};
...
var getPath$1 = (function (parentPath, value) {
  ...
  return flat$2(_context2 = getPath(parentPath, value)).call(_context2, Infinity);
});
...
var assignWatchFields = (function (fieldValues, fieldName, watchFields, combinedDefaultValues) {
  ...
  return isUndefined(value) ? isObject$1(combinedDefaultValues) ? get$1(combinedDefaultValues, fieldName) : combinedDefaultValues : value;
});
...
var indexOf_1 = function (it) {
  var own = it.indexOf;
  return it === ArrayPrototype$b || (it instanceof Array && own === ArrayPrototype$b.indexOf) ? indexOf$1 : own;
};
...
var getFieldArrayParentName = (function (name) {
  return name.substring(0, indexOf$3(name).call(name, '['));
});
...
function useForm(_a) {
  ...
  var watchFieldsRef = React.useRef(new set$4());
  var dirtyFieldsRef = React.useRef(new set$4());
  var fieldsWithValidationRef = React.useRef(new set$4());
  var validFieldsRef = React.useRef(new set$4());
  var isValidRef = React.useRef(true);
  var defaultRenderValuesRef = React.useRef({});
  ...
  var validationContextRef = React.useRef(validationContext);
  var fieldArrayNamesRef = React.useRef(new set$4());

  var _g = __read(React.useState(), 2),
      render = _g[1];

  var _h = React.useRef(modeChecker(mode)).current,
  ...
  var _j = React.useRef(modeChecker(reValidateMode)).current,
  ...
  var shouldRenderBaseOnError = React.useCallback(function (name, error, shouldRender, skipReRender) {
  ...
  var setFieldValue = React.useCallback(function (field, rawValue) {
    var ref = field.ref;
  ...
  var setDirtyAndTouchedFields = React.useCallback(function (fieldName) {
  ...
  var setInternalValueBatch = React.useCallback(function (name, value, parentFieldName) {
  ...
  var setInternalValue = React.useCallback(function (name, value) {
  ...
  var executeSchemaValidation = React.useCallback(function (payload) {
    return __awaiter(_this, void 0, void 0, function () {
  ...
  var triggerValidation = React.useCallback(function (payload) {
    return __awaiter(_this, void 0, void 0, function () {
      var fields, result;
  ...
  var validateSchemaIsValid = React.useCallback(function (values) {
    if (values === void 0) {
      values = {};
    }
  ...
  function registerFieldsRef(ref, validateOptions) {
    ...
    if (!isEmptyObject(defaultValuesRef.current)) {
      defaultValue = get$1(defaultValuesRef.current, name);
      ...
      try {
        for (var _b = __values(values$5(fieldsRef.current)), _c = _b.next(); !_c.done; _c = _b.next()) {
          ...
          if (value) {
            ...
            var inputRef = isRadioOrCheckboxFunction(ref) && isArray$4(options) ? options[0].ref : ref;
  ...
  var commonProps = {
    ...
    setValue: React.useCallback(setValue, [reRender, setInternalValue, triggerValidation]),
    register: React.useCallback(register, [defaultValuesRef.current, defaultRenderValuesRef.current]),
  ...
  var control = __assign(__assign(__assign({
...
var getSortRemovedItems = (function (indexes, removeIndexes, updatedIndexes, count, notFoundIndexes) {
  var e_1, _a, e_2, _b;

  if (updatedIndexes === void 0) {
    updatedIndexes = [];
  }
  ...
  if (notFoundIndexes === void 0) {
    notFoundIndexes = [];
  }

  try {
    for (var removeIndexes_1 = __values(removeIndexes), removeIndexes_1_1 = removeIndexes_1.next(); !removeIndexes_1_1.done; removeIndexes_1_1 = removeIndexes_1.next()) {
      var removeIndex = removeIndexes_1_1.value;

      if (indexOf$3(indexes).call(indexes, removeIndex) < 0) {
    ...
    try {
      if (removeIndexes_1_1 && !removeIndexes_1_1.done && (_a = removeIndexes_1.return)) _a.call(removeIndexes_1);
    } finally {
      if (e_1) throw e_1.error;
    }
  }
  ...
  var _loop_1 = function (index) {
    if (indexOf$3(removeIndexes).call(removeIndexes, index) > -1) {
      updatedIndexes.push(-1);
      count++;
    } else {
      var _context;

      updatedIndexes.push(index - count - (notFoundIndexes.length ? filter$2(_context = map$2(notFoundIndexes).call(notFoundIndexes, function (notFoundIndex) {
        return notFoundIndex < index;
      })).call(_context, Boolean).length : 0));
    }
  };

  try {
    for (var _c = __values(sort$2(indexes).call(indexes)), _d = _c.next(); !_d.done; _d = _c.next()) {
      var index = _d.value;
...
var fillEmptyArray = (function (value) {
  ...
  return isArray$4(value) ? fill$2(_context = Array(value.length)).call(_context, null) : null;
});
...
var useFieldArray = function (_a) {
  ...
  var memoizedDefaultValues = React.useRef(__spread(get$1(fieldArrayDefaultValues.current[getFieldArrayParentName(name)] ? fieldArrayDefaultValues.current : defaultValuesRef.current, name, [])));
  ...
  var appendValueWithKey = function (values) {
    return map$2(values).call(values, function (value) {
      return appendId(value, keyName);
    });
  };
  ...
  var modifyDirtyFields = function (_a) {
    var e_1, _b;

    var _c = _a === void 0 ? {} : _a,
        shouldRender = _c.shouldRender,
        isRemove = _c.isRemove,
        isPrePend = _c.isPrePend,
        index = _c.index,
        _d = _c.value,
        value = _d === void 0 ? {} : _d;

    var render = shouldRender;
    var values = isArray$4(value) ? value : [value];
    ...
    if (readFormStateRef.current.dirty) {
      ...
      if (isPrePend || isRemove) {
        try {
          for (var _e = __values(sort$2(_context = __spread(dirtyFieldsRef.current)).call(_context)), _f = _e.next(); !_f.done; _f = _e.next()) {
            var _context;

            var dirtyField = _f.value;
      ...
      if (!isUndefined(index) || isPrePend) {
        ...
        var updatedDirtyFieldIndexes_1 = isUndefined(index) ? [] : getSortRemovedItems(map$2(_context2 = keys$3(dirtyFieldIndexesAndValues)).call(_context2, function (i) {
          return +i;
        }), isArray$4(index) ? index : [index]);

        forEach$2(_context3 = values$5(dirtyFieldIndexesAndValues)).call(_context3, function (values, index) {
          var e_2, _a;

          var updateIndex = isPrePend ? 0 : updatedDirtyFieldIndexes_1[index];

          if (updateIndex > -1) {
            try {
              for (var values_1 = __values(values), values_1_1 = values_1.next(); !values_1_1.done; values_1_1 = values_1.next()) {
                var value_1 = values_1_1.value;
                var matchedIndexes = value_1.match(REGEX_ARRAY_FIELD_INDEX);

                if (matchedIndexes) {
                  dirtyFieldsRef.current.add(value_1.replace(/[\d+]([^[\d+]+)$/, (isPrePend ? +matchedIndexes[matchedIndexes.length - 1] + values.length : updateIndex) + "$1"));
                }
              }
            } catch (e_2_1) {
              e_2 = {
      ...
      if (!isRemove) {
        forEach$2(values).call(values, function (fieldValue, index) {
          var _context4;

          return forEach$2(_context4 = keys$3(fieldValue)).call(_context4, function (key) {
            return dirtyFieldsRef.current.add(name + "[" + (isPrePend ? index : allFields.current.length + index) + "]." + key);
          });
        });
  ...
  var mapCurrentFieldsValueWithState = function () {
    var currentFieldsValue = get$1(getValues({
      nest: true
    }), name);
  ...
  var append = function (value) {
    setFieldAndValidState(__spread(allFields.current, isArray$4(value) ? appendValueWithKey(value) : [appendId(value, keyName)]));
    modifyDirtyFields({
      value: value
    });
  };

  var prepend$1 = function (value) {
    var shouldRender = false;
    resetFields();
    setFieldAndValidState(prepend(allFields.current, isArray$4(value) ? appendValueWithKey(value) : [appendId(value, keyName)]));
  ...
  var remove = function (index) {
    ...
    if (errorsRef.current[name]) {
      ...
      if (!filter$2(_context5 = errorsRef.current[name]).call(_context5, Boolean).length) {
    ...
    if (readFormStateRef.current.isValid && !validateSchemaIsValid) {
      ...
      while (fieldIndex++ < fields.length) {
        ...
        var isCurrentIndex = indexOf$3(_context6 = isArray$4(index) ? index : [index]).call(_context6, fieldIndex) >= 0;
  ...
  var insert$1 = function (index, value) {
    mapCurrentFieldsValueWithState();
    resetFields(insert(getFieldValueByName(fieldsRef.current, name), index));
    setFieldAndValidState(insert(allFields.current, index, isArray$4(value) ? appendValueWithKey(value) : [appendId(value, keyName)]));
  ...
  var swap = function (indexA, indexB) {
    ...
    setFieldAndValidState(__spread(allFields.current));
...
var Controller = function (_a) {
  ...
  var rulesRef = React.useRef(rules);
