...
function useForm({ mode = VALIDATION_MODE.onSubmit, reValidateMode = VALIDATION_MODE.onChange, validationSchema, validationResolver, validationContext, defaultValues = {}, submitFocusError = true, validateCriteriaMode, } = {}) {
    ...
    const shouldRenderBaseOnError = React.useCallback((name, error, shouldRender, skipReRender) => {
    ...
    const setInternalValueBatch = React.useCallback((name, value, parentFieldName) => {
    ...
    const validateSchemaIsValid = React.useCallback((values = {}) => {
